                ...
                <div class="grid grid-cols-2 sm:grid-cols-1 gap-4">
                    <div>
                        ...
                        <x-form.input id="title" class="block mt-1 w-full" type="text" wire:model="title"
                            wire:keyup="generateSlug" wire:model.live.debounce.200ms="title" required />
                        <x-form.input-error :messages="$errors->get('title')" for="title" class="mt-2" />
                    </div>

                    <div>
                        <x-form.label for="slug" :value="__('Slug')" />
                        <x-form.input id="slug" class="block mt-1 w-full" type="text" wire:model="slug" wire:model.live.debounce.200ms="slug" />
